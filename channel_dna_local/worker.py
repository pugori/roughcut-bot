...
def handle_scan_vod(vod_url_or_no: str, streamer_name: str, dna_profile: str):
    ...
    import cv2
    from pathlib import Path
    from channel_dna_local.core.utils import get_channel_marker_dir, build_vod_folder_and_filenames
    from channel_dna_local.core.guide_generator import GuideGenerator
    from channel_dna_local.core.service import ChannelDNAService
    from channel_dna_local.core.chzzk_client import fetch_chzzk_video_meta, extract_chzzk_video_no
